...
#include <tray.h>
#include <hook.h> // need to uncomments when I finished making linux capunction
...
static void about(struct tray_menu *item){
    ...
    printf("about\n"); 
        ...
        char * url = "xdg-open https://github.com/dennis0324/Capunction";
        system(url);
    #elif TRAY_APPKIT
